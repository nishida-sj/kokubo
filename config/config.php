...
// URL設定
define('SITE_URL', 'http://localhost'); // 本番環境では https://kokubosyokuju.geo.jp
define('ASSET_URL', SITE_URL . '/assets');
define('UPLOAD_URL', SITE_URL . '/uploads');

// データベース設定
define('DB_HOST', 'localhost');
define('DB_NAME', 'kokubo_db');
define('DB_USER', 'root');
define('DB_PASS', '');
...
define('PASSWORD_SALT', 'kokubo_salt_2024'); // 本番環境では複雑な文字列に変更
...
define('MAIL_USE_PHPMAILER', false); // trueでPHPMailer使用
...
// デバッグ設定
define('DEBUG_MODE', true); // 本番環境ではfalse
